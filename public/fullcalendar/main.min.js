...
var FullCalendar = (function (e) {
    ...
    for (n.__k = [], p = 0; p < t.length; p++)
      if (
        ...
        if (
          ((v.__ = n),
          (v.__b = n.__b + 1),
          null === (h = C[p]) || (h && v.key == h.key && v.type === h.type))
        )
          C[p] = void 0;
        else
          for (f = 0; f < D; f++) {
        ...
        if (
          ...
          if (
            (null == w.getDerivedStateFromProps &&
              ...
              d.componentWillReceiveProps(E, C),
            (!d.__e &&
              null != d.shouldComponentUpdate &&
              !1 === d.shouldComponentUpdate(E, d.__s, C)) ||
              t.__v === n.__v)
          ) {
            (d.props = E),
              (d.state = d.__s),
  ...
  function Ve(e) {
    e.classList.remove("fc-unselectable"),
      e.removeEventListener("selectstart", Ie);
  }
  function Fe(e) {
  ...
  function qe(e, t, n) {
    var r, o;
    for (r = 0; r < n.length; r += 1) if ((o = Ye(e, t, n[r]))) return o;
    return 0;
  }
  function Ye(e, t, n) {
  ...
  function wt(e, t) {
    if (e === t) return !0;
    for (var n in e) if (St.call(e, n) && !(n in t)) return !1;
    for (var n in t) if (St.call(t, n) && e[n] !== t[n]) return !1;
    return !0;
  }
  function Tt(e, t) {
    var n = [];
  ...
  function _t(e, t, n) {
    ...
    for (var r in t) if (!(r in e) || !xt(e[r], t[r], n[r])) return !1;
  ...
  function Mt(e, t, n) {
    ...
    a)) {
      ...
      if (u.recurringDef) {
        ...
        for (
          var d = 0, p = It(u, c, t, r, o.recurringTypes);
          d < p.length;
          d++
        ) {
          var f = p[d],
            h = yt(l, { start: f, end: r.add(f, c) });
          s[h.instanceId] = h;
        }
      }
    }
  ...
  function Yt(e) {
    return (
      Xe(e.getUTCHours(), 2) +
      ":" +
      Xe(e.getUTCMinutes(), 2) +
      ":" +
      Xe(e.getUTCSeconds(), 2)
    );
  }
  function Zt(e, t) {
    void 0 === t && (t = !1);
  ...
  var tn = {
    ...
    un = (function () {
      function e(e) {
        ...
        for (var o in e)
          o in tn
            ? ((n[o] = e[o]), (r = Math.max(tn[o], r)))
            : ((t[o] = e[o]), o in nn && (r = Math.max(nn[o], r)));
        (this.standardDateProps = t),
          (this.extendedSettings = n),
          (this.severity = r),
          (this.buildFormattingFunc = $t(cn));
      }
      return (
  ...
  function Tn(e, t, n, r) {
    for (
      var o = { defs: {}, instances: {} }, i = Fn(n), a = 0, s = e;
      a < s.length;
      a++
    ) {
  ...
  var Ln = {
    ...
    Un = { start: wn, end: wn, date: wn, allDay: Boolean },
    Bn = r(r(r({}, Ln), Un), { extendedProps: wn });
  ...
  function qn(e, t) {
    ...
    return (
      e.start && ((n = ut(e.start)), r && r <= n && (r = nt(n, 1))),
      { start: n, end: r }
    );
  }
  function Yn(e) {
  ...
  function Xn(e, t) {
    var n,
      ...
      o = [],
      i = t.start;
    for (e.sort(Kn), n = 0; n < e.length; n += 1)
  ...
  var yr = { start: wn, end: wn, allDay: Boolean };
  function Sr(e, t, n) {
    var o = (function (e, t) {
        var n = Rn(e, yr),
          o = n.refined,
  ...
  function Tr(e, t, n) {
    ...
    return (
      e
        ? ((i = ut(i)), (i = r.add(i, o.defaultAllDayEventDuration)))
  ...
  function kr(e, t, n, o, i) {
    ...
    return (
      ...
      t.allDay &&
        (u.range = { start: ut(u.range.start), end: ut(u.range.end) }),
      u.range.end < u.range.start &&
        (u.range.end = Tr(t.allDay, u.range.start, i)),
      u
    );
  }
  var Mr = (function () {
      ...
      return (
        ...
        (e.prototype.addEvent = function (e, t) {
          if (e instanceof Ar) {
            ...
            return (
              this.getCurrentData().eventStore.defs[n.defId] ||
                (this.dispatch({
                  type: "ADD_EVENTS",
                  eventStore: _n({ def: n, instance: r }),
                }),
          ...
          if (s) {
            ...
            return (
              this.dispatch({ type: "ADD_EVENTS", eventStore: _n(s) }),
      ...
      return (
        (e.prototype.setProp = function (e, t) {
          ...
          if (e in Un)
            ...
            (t = Ln[e](t)), this.mutate({ standardProps: { publicId: t } });
          else if (e in Ln)
            (t = Ln[e](t)),
  ...
  var Gr = (function () {
      ...
      return (
        ...
        (e.prototype.diffWholeMonths = function (e, t) {
          var n = this.calendarSystem;
          return mt(e) === mt(t) && n.getMarkerDay(e) === n.getMarkerDay(t)
            ? n.getMarkerMonth(t) -
                n.getMarkerMonth(e) +
        ...
        (e.prototype.timestampToMarker = function (e) {
          return "local" === this.timeZone
            ...
            ? vt(this.namedTimeZoneImpl.timestampToArray(e))
            : new Date(e);
        }),
        (e.prototype.offsetForMarker = function (e) {
          return "local" === this.timeZone
            ? -ft(ht(e)).getTimezoneOffset()
            : "UTC" === this.timeZone
            ? 0
  ...
  function $r(e) {
    ...
    return new Gr(
      r(r({ timeZone: mn.timeZone, calendarSystem: "gregory" }, e), {
        locale: t,
      })
    );
  }
  ...
  var lo = { defs: {}, instances: {} },
    uo = (function () {
      function e() {
        (this.getKeysForEventDefs = $t(this._getKeysForEventDefs)),
          (this.splitDateSelection = $t(this._splitDateSpan)),
          (this.splitEventStore = $t(this._splitEventStore)),
          (this.splitIndividualUi = $t(this._splitIndividualUi)),
          (this.splitEventDrag = $t(this._splitInteraction)),
          (this.splitEventResize = $t(this._splitInteraction)),
  ...
  var vo = vn({ year: "numeric", month: "long", day: "numeric" }),
    go = vn({ week: "long" });
  function mo(e, t, n, o) {
    ...
    if (a.navLinks) {
      ...
      return r(
        { title: Ke(a.navLinkHint, [l, u], l), "data-navlink": "" },
        o ? Oe(c) : { onClick: c }
      );
    }
    return { "aria-label": l };
  ...
  if (
    ...
    (No.prototype.baseIconClass = ""),
    (No.prototype.iconOverridePrefix = ""),
  ...
  (ei.prototype.classes = {
    ...
    (ei.prototype.baseIconClass = "fc-icon"),
    ...
    (ei.prototype.iconOverrideOption = "buttonIcons"),
    (ei.prototype.iconOverrideCustomButtonOption = "icon"),
    (ei.prototype.iconOverridePrefix = "fc-icon-");
  var ni = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
        return (
  ...
  var ii = (function (e) {
      ...
      return (
        ...
        (t.prototype.getInnerContent = function () {
          ...
          return (
            void 0 === t && (t = ui(e.defaultContent, e.hookProps)),
            null == t ? null : t
          );
        }),
  ...
  function si() {
    ...
    return function (r, o) {
      return (
        (t && wt(t, o) && r === e) || ((e = r), (t = o), (n = li(r, o))), n
      );
    };
  }
  function li(e, t) {
      ...
      n.content &&
        ...
        (o = function (e) {
          return Oo(Go.Consumer, null, function (n) {
            return Oo(ci, { viewSpec: n.viewSpec }, function (o, i) {
              var a = r(r({}, e), {
  ...
  var vi = (function () {
    function e(e) {
      (this.props = e),
        (this.nowDate = Hr(e.nowInput, e.dateEnv)),
        this.initHiddenDays();
    }
    return (
      ...
      (e.prototype.build = function (e, t, n) {
        ...
        return (
          ...
          d.showNonCurrentDates || (s = $n(s, o.range)),
          (s = $n((s = this.adjustActiveRange(s)), r)),
          (l = Qn(o.range, r)),
          {
            validRange: r,
      ...
      (e.prototype.adjustActiveRange = function (e) {
        ...
        return (
          r &&
            (Ut(o) < 0 && ((a = ut(a)), (a = n.add(a, o))),
            Ut(i) > 1 && ((s = nt((s = ut(s)), -1)), (s = n.add(s, i)))),
          { start: a, end: s }
        );
      }),
      (e.prototype.buildRangeFromDuration = function (e, t, n, r) {
        ...
        return (
          Ut(n) <= 1 &&
            this.isHiddenDay(o) &&
            (o = ut((o = this.skipHiddenDays(o, t)))),
          d(),
  ...
  function mi(e, t, n, o) {
    ...
    switch (t.type) {
      ...
      case "FETCH_EVENT_SOURCES":
        return bi(
          e,
          t.sourceIds ? Dt(t.sourceIds) : Di(e, o),
          s,
          t.isRefetch || !1,
          o
        );
      ...
      eventSourceDefs: [
        {
          ...
          fetch: function (e, t, n) {
            ...
            _o(
              e.eventSource.meta.bind(null, br(e.range, r)),
              function (e) {
                t({ rawEvents: e });
              },
              n
      ...
      recurringTypes: [
        {
          ...
          expand: function (e, t, n) {
            var r = $n(t, { start: e.startRecur, end: e.endRecur });
            return r
              ? (function (e, t, n, r) {
                  var o = e ? Dt(e) : null,
                    i = ut(n.start),
    ...
    Jo({
      ...
      propSetHandlers: {
        dateProfile: function (e, t) {
          t.emitter.trigger(
            "datesSet",
            r(r({}, br(e.activeRange, t.dateEnv)), { view: t.viewApi })
          );
        },
    ...
    Bi = (function () {
      function e(e, t) {
        (this.runTaskOption = e),
          ...
          (this.queue = []),
          (this.delayedRunner = new Ui(this.drain.bind(this)));
      }
      return (
  ...
  var Vi = (function () {
    function e(e) {
      var t = this;
      (this.computeOptionsData = $t(this._computeOptionsData)),
        (this.computeCurrentViewData = $t(this._computeCurrentViewData)),
        (this.organizeRawLocales = $t(Zr)),
        (this.buildLocale = $t(Xr)),
        (this.buildPluginHooks = Qo()),
        (this.buildDateEnv = $t(Fi)),
        (this.buildTheme = $t(Gi)),
        (this.parseToolbars = $t(Pi)),
        (this.buildViewSpecs = $t(fi)),
        (this.buildDateProfileGenerator = Jt(ji)),
        (this.buildViewApi = $t(qi)),
        (this.buildViewUiProps = Jt(Xi)),
        (this.buildEventUiBySource = $t(Yi, wt)),
        (this.buildEventUiBases = $t(Zi)),
        (this.parseContextBusinessHours = Jt($i)),
        (this.buildTitle = $t(zi)),
        (this.emitter = new xo()),
        (this.actionRunner = new Bi(
      ...
      var s,
        ...
        c =
          ((s = o.calendarOptions),
          (l = o.dateEnv),
          null != (u = s.initialDate) ? l.createMarker(u) : Hr(s.now, l)),
      ...
      for (
        var v = gi(o.calendarOptions, d, p),
          g = {
      ...
      Ki(g, p) && this.emitter.trigger("loading", !0),
        (this.state = g),
        this.updateData(),
    ...
    return (
      ...
      (e.prototype._handleAction = function (e) {
        ...
        this.data &&
          ...
          ("PREV" !== e.type && "NEXT" !== e.type && tr(p.currentRange, d)) ||
            (d = p.currentRange.start);
        for (
          var f = mi(o.eventSources, e, p, c),
      ...
      (e.prototype.processRawCalendarOptions = function (e, t) {
        var n = Dn([mn, e, t]),
          ...
          c = (this.currentCalendarOptionsRefiners = r(
            r(r(r(r({}, gn), yn), Sn), u.listenerRefiners),
            u.optionRefiners
          )),
          d = {},
          p = Dn([mn, l, e, t]),
        ...
        for (var m in p)
          "plugins" !== m &&
            (p[m] === h[m] || (En[m] && m in h && En[m](h[m], p[m]))
              ? (f[m] = v[m])
              : c[m]
              ? ((f[m] = c[m](p[m])), (g = !0))
              : (d[m] = h[m]));
      ...
      (e.prototype.processRawViewOptions = function (e, t, n, o, i) {
        var a = Dn([mn, e.optionDefaults, n, o, e.optionOverrides, i]),
          s = r(
            r(r(r(r(r({}, gn), yn), Sn), Cn), t.listenerRefiners),
            t.optionRefiners
          ),
          l = {},
      ...
      return (
        ...
        (e.prototype.insertEntryAt = function (e, t) {
          ...
          -1 === t.lateral
            ...
            (this.stackCnts[ra(e)] = t.stackCnt);
        }),
        (e.prototype.findInsertion = function (e) {
          ...
          var E = -1;
          return (
            S < a && n[S] === s && (E = la(r[S], e.span.end, na)[0]),
            {
              touchingLevel: l,
              touchingLateral: u,
              touchingEntry: c,
  ...
  var pa = {},
    ...
    ha = {},
    va = { startTime: Ht, duration: Ht, create: Boolean, sourceId: String };
  function ga(e) {
    var t = Rn(e, va),
      n = t.refined,
      r = t.extra;
  ...
  var ma = (function (e) {
      ...
      return (
        ...
        (t.prototype.renderWidgetGroup = function (e) {
          ...
          if (r.length > 1) {
            ...
            return Oo.apply(void 0, o(["div", { className: m }], r));
          }
          return r[0];
        }),
        t
    ...
    Ca = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
        return (
          (t.buildViewContext = $t(jo)),
          (t.buildViewPropTransformers = $t(Ra)),
          (t.buildToolbarProps = $t(Da)),
          (t.headerRef = Wo()),
          (t.footerRef = Wo()),
          (t.interactionsStore = {}),
          (t.state = { viewLabelId: Me() }),
  ...
  var ka = (function (e) {
    ...
    Pa = (function (e) {
      function t(t, n) {
        ...
        return (
          (r.initialNowDate = Hr(n.options.now, n.dateEnv)),
  ...
  var Ha = (function (e) {
    ...
    return (
      ...
      (t.prototype.render = function () {
        ...
        return Oo(Pa, { unit: "day" }, function (e, t) {
          return Oo(
            "tr",
            { role: "row" },
            i && i("day"),
  ...
  var Aa = (function () {
    ...
    La = (function () {
      function e() {
        (this.sliceBusinessHours = $t(this._sliceBusinessHours)),
          (this.sliceDateSelection = $t(this._sliceDateSpan)),
          (this.sliceEventStore = $t(this._sliceEventStore)),
      ...
      return (
        ...
        (e.prototype.sliceNowDate = function (e, t) {
          ...
          return this._sliceDateSpan.apply(
            this,
            o([{ range: { start: e, end: rt(e, 1) }, allDay: !1 }, {}, t], n)
          );
        }),
        ...
        (e.prototype.sliceEventRange = function (e, t) {
          ...
          this.forceDayIfListItem &&
            ...
            (n = { start: n.start, end: nt(n.start, 1) });
          for (
  ...
  function Ba(e, t, n) {
    ...
    for (var o in r) if (!er(t.validRange, r[o].range)) return !1;
    return Va({ eventDrag: e }, n);
  }
  function za(e, t, n) {
    return !!er(t.validRange, e.range) && Va({ dateSelection: e }, n);
  }
  function Va(e, t) {
      ...
      !(
        ...
        !(function (e, t, n, o) {
          var i = t.getCurrentData(),
            ...
            l = s.defs,
            u = s.instances,
            c = ar(l, a.isEvent ? e.eventUiBases : { "": i.selectionConfig });
          o && (c = Ct(c, o));
          var d =
              ((v = e.eventStore),
          ...
          for (var m in u) {
            ...
            for (var R in f) {
              ...
              if (Qn(S, w.range)) {
                ...
                if (D && !D(new Ar(t, p[w.defId], w), new Ar(t, b, y)))
                  return !1;
              }
            }
            for (var T = i.eventStore, _ = 0, x = E.allows; _ < x.length; _++) {
              var k = x[_],
                ...
                P = T.instances[m],
                N = void 0;
              if (((N = I ? new Ar(t, I, P) : new Ar(t, b)), !k(wr(M, t), N)))
                return !1;
            }
          }
          return !0;
  ...
  function $a(e) {
    for (
      var t = 0, n = 0, r = Ce(e, ".fc-scrollgrid-shrink");
      n < r.length;
      n++
    ) {
      var o = r[n];
  ...
  var cs = (function (e) {
    function t() {
      var t = (null !== e && e.apply(this, arguments)) || this;
      return (
        (t.processCols = $t(function (e) {
          return e;
        }, ts)),
        (t.renderMicroColGroup = $t(ns)),
        (t.scrollerRefs = new Ka()),
        (t.scrollerElRefs = new Ka(t._handleScrollerEl.bind(t))),
        (t.state = {
          shrinkWidth: null,
          forceYScrollbars: !1,
    ...
    return (
      ...
      (t.prototype.render = function () {
        ...
        return Oo(
          ...
          Boolean(!v && p.length) && Oo.apply(void 0, o(["thead", g], p)),
          Boolean(!v && f.length) && Oo.apply(void 0, o(["tbody", g], f)),
          Boolean(!v && h.length) && Oo.apply(void 0, o(["tfoot", g], h)),
          v && Oo.apply(void 0, o(o(o(["tbody", g], p), f), h))
        );
      }),
      (t.prototype.renderSection = function (e, t, n) {
        return "outerContent" in e
          ? Oo(Lo, { key: e.key }, e.outerContent)
          : Oo(
              "tr",
              {
                key: e.key,
  ...
  cs.addStateEquality({ scrollerClientWidths: wt, scrollerClientHeights: wt });
  var ds = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
        return (t.elRef = Wo()), t;
  ...
  function fs(e) {
    return Oo(
      ...
      e.timeText && Oo("div", { className: "fc-event-time" }, e.timeText),
      Oo(
        "div",
  ...
  function bs(e) {
    return (
      e.event.title && Oo("div", { className: "fc-event-title" }, e.event.title)
    );
  }
  var Cs = function (e) {
    return Oo(Go.Consumer, null, function (t) {
  ...
  var Rs = (function (e) {
      ...
      return (
        ...
        (t.prototype.updateSize = function () {
          var e = this.context.isRtl,
            ...
            i = (function (e) {
              for (
                var t = To(e), n = e.getBoundingClientRect(), r = 0, o = t;
                r < o.length;
                r++
              ) {
    ...
    Ts = (function (e) {
      function t() {
        ...
        return (
          (t.linkElRef = Wo()),
          (t.state = { isPopoverOpen: !1, popoverId: Me() }),
  ...
  function xs(e) {
    if (e.allDayDate) return { start: e.allDayDate, end: nt(e.allDayDate, 1) };
    var t,
      n = e.hiddenSegs;
    return { start: ks(n), end: ((t = n), t.reduce(Is).eventRange.range.end) };
  }
  function ks(e) {
  ...
  var Ps = (function (e) {
    function t(t, n) {
      ...
      return (
                ...
                function (t, n, i, a) {
                  return (
                    ...
                    Oo(
                      ...
                      Oo(Ca, r({ isHeightAuto: i, forPrint: a }, e))
                    )
                  );
                }
              ),
        ...
        (o.el = t),
        (o.renderRunner = new Ui(o.handleRenderRequest)),
        new Vi({
          optionOverrides: n,
          calendarApi: o,
    ...
    As = (function () {
      function e(e) {
        ...
        (this.subjectEl = null),
          ...
          1 === (Hs += 1) &&
            window.addEventListener("touchmove", Ws, { passive: !1 });
      }
      return (
        (e.prototype.destroy = function () {
          this.containerEl.removeEventListener(
            ...
            (Hs -= 1) ||
              window.removeEventListener("touchmove", Ws, { passive: !1 });
        }),
  ...
  var Ls = (function () {
    ...
    js = (function () {
      function e(e) {
        (this.origRect = wo(e)),
          (this.scrollCaches = To(e).map(function (e) {
            return new Bs(e, !0);
          }));
      }
      return (
        ...
        for (var i in n) {
          ...
          if (s && s.isWithinClipping(e, t)) {
            ...
            if (c >= 0 && c < f && d >= 0 && d < h) {
              ...
              v &&
                er(v.dateProfile.activeRange, v.dateSpan.range) &&
                (!o || v.layer > o.layer) &&
                ((v.componentId = i),
                (v.context = a.context),
                (v.rect.left += l),
  ...
  function Ys(e, t) {
    return (
      (!e && !t) || (Boolean(e) === Boolean(t) && Er(e.dateSpan, t.dateSpan))
    );
  }
  function Zs(e, t) {
    for (
          ...
          (n.handleHitUpdate = function (e, t) {
            ...
            if (e) {
              ...
              (e.componentId === s.componentId &&
                ...
                (i && za(i, e.dateProfile, o)) || ((a = !0), (i = null));
            }
            i
    ...
    function t(n) {
      ...
      (o.subjectEl = null),
        ...
        (o.handlePointerDown = function (e) {
          ...
          (o.relevantEvents = xn(l.getCurrentData().eventStore, c)),
            ...
            if (e) {
              ...
              i === a || (d.editable && d.droppable)
                ? (s = (function (e, t, n) {
                  ...
                  ((l = _r(n, a.getCurrentData().eventUiBases, s, a)),
                  (c.mutatedEvents = l),
    ...
    function t(t) {
      ...
      (n.draggingSegEl = null),
        ...
        (n.handleHitUpdate = function (e, t, r) {
          ...
          l &&
            ((u = _r(i, o.getCurrentData().eventUiBases, l, o)),
            (d.mutatedEvents = u),
        ...
        (this.context = e),
          ...
          (this.onDocumentPointerDown = function (e) {
            ...
            (t.matchesCancel = !!Ee(r, n)),
              (t.matchesEvent = !!Ee(r, $s.SELECTOR));
          }),
              ...
              n.canDropElOnCalendar(o.subjectEl, a) &&
                ((s = (function (e, t, n) {
                  ...
                  var f = t.duration
                      ...
                      : Tr(e.allDay, p, n),
                    h = yt(d.defId, { start: p, end: f });
                  return { def: d, instance: h };
                })(e.dateSpan, n.dragMeta, a)),
                (u.mutatedEvents = _n(s)),
      ...
      return (
        (e.prototype.buildDragMeta = function (e) {
          return "object" == typeof this.suppliedDragMeta
            ? ga(this.suppliedDragMeta)
            : "function" == typeof this.suppliedDragMeta
            ? ga(this.suppliedDragMeta(e))
            : ga(
                (t = (function (e, t) {
        ...
        void 0 === t && (t = {}),
          (this.handlePointerDown = function (e) {
            var t = n.dragging,
              ...
              i = r.longPressDelay;
            (t.minDistance =
              null != o ? o : e.isTouch ? 0 : mn.eventDragMinDistance),
              (t.delay = e.isTouch ? (null != i ? i : mn.longPressDelay) : 0);
          }),
          (this.handleDragStart = function (e) {
            e.isTouch &&
              n.dragging.delay &&
      ...
      return (
        ...
        (t.prototype.renderSimpleLayout = function (e, t) {
          ...
          return (
            ...
            Oo(ci, { viewSpec: r.viewSpec }, function (e, t) {
              return Oo(
                "div",
        ...
        (t.prototype.renderHScrollLayout = function (e, t, n, r) {
          ...
          return (
            ...
            Oo(ci, { viewSpec: a.viewSpec }, function (e, t) {
              return Oo(
                "div",
                { ref: e, className: ["fc-daygrid"].concat(t).join(" ") },
                Oo(o, {
  ...
  var El = vn({ week: "narrow" }),
    bl = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
        return (
          (t.rootElRef = Wo()),
          (t.state = { dayNumberId: Me() }),
          (t.handleRootEl = function (e) {
            ...
            function (e, t, u, c) {
              return Oo(
                ...
                Oo(
                  ...
                  Oo("div", { className: "fc-daygrid-day-bg" }, n.bgContent)
                )
              );
            }
          );
  ...
  function Dl(e, t, n, o) {
    ...
    var i = e.eventRange,
      a = i.range,
      s = $n(a, { start: o[t].date, end: nt(o[n - 1].date, 1) });
    return r(r({}, e), {
      firstCol: t,
      lastCol: n - 1,
      eventRange: {
  ...
  var Rl = (function (e) {
          ...
          if (this.hiddenConsumes && s) {
            ...
            if (!a[c])
              if (this.allowReslicing) {
                var d = r(r({}, s), { span: aa(s.span, n.span) });
    ...
    wl = (function (e) {
      function t() {
        ...
        return (
          (t.cellElRefs = new Ka()),
          (t.frameElRefs = new Ka()),
          (t.fgElRefs = new Ka()),
          (t.segHarnessRefs = new Ka()),
          (t.rootElRef = Wo()),
          (t.state = {
            framePositions: null,
        ...
        (t.prototype.renderFgSegs = function (e, t, n, o, i, a, s) {
          ...
          if (c)
            for (var h = 0, v = t; h < v.length; h++) {
              ...
              b &&
                (l.isRtl
                  ? ((D = 0), (C = c.lefts[m.lastCol] - c.lefts[m.firstCol]))
                  : ((C = 0),
            ...
            for (var l = 0, u = e; l < u.length; l++) {
              ...
              s.push(
                Oo(
                  ...
                  "bg-event" === t ? Oo(Es, r({ seg: c }, hr(c, i))) : Ss(t)
                )
              );
            }
  ...
  var Tl = (function (e) {
    function t() {
      var t = (null !== e && e.apply(this, arguments)) || this;
      return (
        (t.splitBusinessHourSegs = $t(ll)),
        (t.splitBgEventSegs = $t(ll)),
        (t.splitFgEventSegs = $t(ll)),
        (t.splitDateSelectionSegs = $t(ll)),
        (t.splitEventDrag = $t(cl)),
        (t.splitEventResize = $t(cl)),
        (t.rowRefs = new Ka()),
        (t.handleRootEl = function (e) {
          (t.rootEl = e),
            e
  ...
  function Ol(e) {
    ...
    return Oo(Go.Consumer, null, function (n) {
      if (!e.isLabeled)
        return Oo("td", { className: t.join(" "), "data-time": e.isoTimeStr });
      var r = n.dateEnv,
        o = n.options,
        i = n.viewApi,
        a =
          null == o.slotLabelFormat
            ...
            ? vn(o.slotLabelFormat[0])
            : vn(o.slotLabelFormat),
        s = {
          level: 0,
          time: e.time,
      ...
      return (
        ...
        (t.prototype.render = function () {
          return this.props.slatMetas.map(function (e) {
            return Oo("tr", { key: e.key }, Oo(Ol, r({}, e)));
          });
        }),
        t
      );
        ...
        return (
          ...
          (t.renderHeadAxis = function (e, n) {
            ...
            var o = t.context.options,
              ...
              a =
                1 === it(i.start, i.end) ? mo(t.context, i.start, "week") : {};
            return o.weekNumbers && "day" === e
              ? Oo(
                  Cs,
                  { date: i.start, defaultFormat: Ll },
                  function (e, t, o, i) {
                    return Oo(
                      "th",
                      {
                  ...
                  content: function (e) {
                    return Oo(
                      ...
                      Oo(
                        ...
                        e.tableColGroupNode,
                        Oo("tbody", null, Oo(Wl, { slatMetas: i }))
                      ),
                      Oo(
                        "div",
                        { className: "fc-timegrid-now-indicator-container" },
                        Oo(Pa, { unit: h ? "minute" : "day" }, function (e) {
  ...
  var zl = (function () {
      ...
      return (
        ...
        (e.prototype.computeDateTop = function (e, t) {
          return (
            t || (t = ut(e)), this.computeTimeTop(Ht(e.valueOf() - t.valueOf()))
          );
        }),
  ...
  var eu = vn({ hour: "numeric", minute: "2-digit", meridiem: !1 }),
    tu = (function (e) {
      function t() {
        return (null !== e && e.apply(this, arguments)) || this;
      }
      return (
        ...
        (t.prototype.render = function () {
          ...
          return (
            ...
            Oo(
              ps,
              r({}, this.props, { defaultTimeFormat: eu, extraClassNames: e })
            )
          );
        }),
        t
      ...
      return (
        ...
        (t.prototype.render = function () {
          ...
          return Oo(
            ...
            function (e, t) {
              return (
                t && Oo("div", { className: "fc-timegrid-col-misc", ref: e }, t)
              );
            }
          );
        }),
            ...
            i = Ql(e, n.date, n.slatCoords, o.options.eventMinHeight).map(
              function (o, i) {
                ...
                return Oo(
                  ...
                  "bg-event" === t
                    ? Oo(Es, r({ seg: a }, hr(a, n.todayRange, n.nowDate)))
                    : Ss(t)
                );
              }
            );
  ...
  var au = (function (e) {
    function t() {
      var t = (null !== e && e.apply(this, arguments)) || this;
      return (
        (t.splitFgEventSegs = $t(Gl)),
        (t.splitBgEventSegs = $t(Gl)),
        (t.splitBusinessHourSegs = $t(Gl)),
        (t.splitNowIndicatorSegs = $t(Gl)),
        (t.splitDateSelectionSegs = $t(Gl)),
        (t.splitEventDrag = $t(jl)),
        (t.splitEventResize = $t(jl)),
        (t.rootElRef = Wo()),
        (t.cellElRefs = new Ka()),
        t
      );
    ...
    cu = (function (e) {
      ...
      return (
        ...
        (t.prototype.render = function () {
          ...
          return Oo(Pa, { unit: a ? "minute" : "day" }, function (l, u) {
            return Oo(
              su,
  ...
  var Su = vn({ hour: "numeric", minute: "2-digit", meridiem: "short" }),
    Eu = (function (e) {
      function t() {
        return (null !== e && e.apply(this, arguments)) || this;
      }
                ...
                (function (e, t, n, r, o) {
                  ...
                  if (!1 !== i.displayEventTime) {
                    ...
                    if (
                      (a.allDay
                        ? (l = !0)
                        : Yn(e.eventRange.range)
                        ? e.isStart
                          ? (u = fr(e, t, n, null, null, s.range.start, e.end))
                          : e.isEnd
                          ? (u = fr(e, t, n, null, null, e.start, s.range.end))
                          : (l = !0)
                        : (u = fr(e, t, n)),
                      l)
                    ) {
                    ...
                    return Oo("td", { className: "fc-list-event-time" }, u);
                  }
                  return null;
                })(n, s, t, o, a),
                Oo(
  ...
  var Cu = (function (e) {
    function t() {
      var t = (null !== e && e.apply(this, arguments)) || this;
      return (
        (t.computeDateVars = $t(Ru)),
        (t.eventStoreToSegs = $t(t._eventStoreToSegs)),
        (t.state = {
          timeHeaderId: Me(),
          eventHeaderId: Me(),
          dateHeaderIdRoot: Me(),
    ...
    return (
        ...
        return Oo(
          ...
          function (e, t, n, r) {
            return Oo(
              ...
              Oo("div", { className: "fc-list-empty-cushion", ref: n }, r)
            );
          }
        );
      }),
      (t.prototype.renderSegList = function (e, t) {
        ...
        return Oo(Pa, { unit: "day" }, function (e, n) {
          for (var a = [], d = 0; d < c.length; d += 1) {
            ...
            if (p) {
              var f = qt(t[d]),
                h = u + "-" + f;
              a.push(
                Oo(mu, { key: f, cellId: h, dayDate: t[d], todayRange: n })
              );
              for (
                var v = 0, g = (p = lr(p, i.eventOrder));
                v < g.length;
                v++
              ) {
                var m = g[v];
          ...
          return Oo(
            ...
            Oo(
              ...
              Oo(
                "tr",
                null,
                Oo("th", { scope: "col", id: s }, i.timeHint),
                Oo("th", { scope: "col", "aria-hidden": !0 }),
                Oo("th", { scope: "col", id: l }, i.eventHint)
              )
            ),
            Oo("tbody", null, a)
          );
  ...
  function Ru(e) {
    for (
      var t = ut(e.renderRange.start), n = e.renderRange.end, r = [], o = [];
      t < n;

    )
      r.push(t), o.push({ start: t, end: nt(t, 1) }), (t = nt(t, 1));
  ...
  (_u.prototype.classes = {
    ...
    (_u.prototype.baseIconClass = "fa"),
    (_u.prototype.iconClasses = {
      close: "fa-times",
    ...
    (_u.prototype.iconOverrideOption = "bootstrapFontAwesome"),
    (_u.prototype.iconOverrideCustomButtonOption = "bootstrapFontAwesome"),
    (_u.prototype.iconOverridePrefix = "fa-");
  var xu = Jo({ themeClasses: { bootstrap: _u } }),
              ...
              var u = (function (e) {
                ...
                p = (function (e, t, n, o) {
                  ...
                  o.canComputeOffset
                    ...
                    : ((a = nt(e.start, -1).toISOString()),
                      (s = nt(e.end, 1).toISOString()));
                  (i = r(r({}, n || {}), {
                    key: t,
                    timeMin: a,
                    timeMax: s,
        ...
        function (e) {
          ...
          if (!/\w+:\/\/fullcalendar\.io\/|\/examples\/[\w-]+\.html$/.test(n)) {
            ...
            if ("valid" !== r)
              return Oo(
                "div",
                { className: "fc-license-message", style: Nu },
                "outdated" === r
                  ? Oo(
                      Lo,
                      null,
    ...
    Wu = (function () {
      function e(e) {
        ...
        (this.el = e),
          ...
          (this.wheelWaiter = new Ui(this._handleWheelWaited.bind(this))),
          (this.scrollWaiter = new Ui(this._handleScrollWaited.bind(this))),
  ...
  var zu,
    Vu = "undefined" != typeof navigator && /Edge/.test(navigator.userAgent),
    Fu = (function () {
      function e(e, t) {
        var n = this;
        (this.scrollEl = e),
  ...
  var Gu = (function (e) {
    ...
    qu = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
        return (
          (t.compileColGroupStats = Qt(Ku, Qu)),
          (t.renderMicroColGroups = Qt(ns)),
          (t.clippedScrollerRefs = new Ka()),
          (t.scrollerElRefs = new Ka(t._handleScrollerEl.bind(t))),
          (t.chunkElRefs = new Ka(t._handleChunkEl.bind(t))),
          (t.getStickyScrolling = Qt(nc, null, rc)),
          (t.getScrollSyncersBySection = en(ec.bind(t, !0), null, tc)),
          (t.getScrollSyncersByColumn = en(ec.bind(t, !1), null, tc)),
          (t.stickyScrollings = []),
      ...
      return (
          ...
          return Oo(
            ...
            (function (e, t) {
              var n = e.map(function (e, n) {
                var r = e.width;
                return (
                  "shrink" === r && (r = e.totalColWidth + rs(t[n]) + 1),
                  Oo("col", { style: { width: r } })
                );
              });
              return Oo.apply(void 0, o(["colgroup", {}], n));
            })(a, i),
            Boolean(!m && h.length) && Oo.apply(void 0, o(["thead", y], h)),
            Boolean(!m && v.length) && Oo.apply(void 0, o(["tbody", y], v)),
            Boolean(!m && g.length) && Oo.apply(void 0, o(["tfoot", y], g)),
            m && Oo.apply(void 0, o(o(o(["tbody", y], h), v), g))
          );
        }),
        ...
        (t.prototype.renderChunk = function (e, t, n, r, o, i, a, s) {
          if ("outerContent" in o)
            return Oo(Lo, { key: o.key }, o.outerContent);
          var l = this.state,
        ...
        (t.prototype.allowSizing = function () {
          ...
          return !this.lastSizingDate ||
            e.valueOf() >
              this.lastSizingDate.valueOf() + ha.SCROLLGRID_RESIZE_INTERVAL
        ...
        (t.prototype.destroyScrollSyncers = function () {
          Ct(this.scrollSyncersBySection, tc),
            Ct(this.scrollSyncersByColumn, tc);
        }),
  ...
  var oc = Jo({ deps: [Ou], scrollGridImpl: qu });
  (ha.SCROLLGRID_RESIZE_INTERVAL = 500),
    (ha.COLLAPSIBLE_WIDTH_THRESHOLD = 1200);
  var ic = [],
    ac = [],
    sc = Jo({
      deps: [Ou],
      contextInit: function (e) {
        ic.length ||
          (window.addEventListener("beforeprint", lc),
          window.addEventListener("afterprint", uc)),
          ic.push(e),
          e.calendarApi.on("_unmount", function () {
            Xt(ic, e),
              ic.length ||
                (window.removeEventListener("beforeprint", lc),
                window.removeEventListener("afterprint", uc));
          });
      },
    });
  function lc() {
  ...
  function cc(e) {
    ...
    (!e.classList.contains("fc-scrollgrid-collapsible") ||
      t < ha.COLLAPSIBLE_WIDTH_THRESHOLD) &&
      (e.style.width = t + "px");
  }
  function dc(e) {
    e.style.width = "";
  ...
  function fc(e, t, n, r) {
    ...
    (o.largeUnit = s),
      (o.emphasizeWeeks =
        1 === At(o.slotDuration) && mc("weeks", e, t) >= 2 && !n.businessHours);
    var u,
      c,
      d = n.snapDuration;
    d && ((u = Ht(d)), (c = Ft(o.slotDuration, u))),
    ...
    o.isTimeScale &&
      ((f = t.add(f, e.slotMinTime)), (h = t.add(nt(h, -1), e.slotMaxTime))),
      (o.timeWindowMs = p),
      (o.normalizedRange = { start: f, end: h });
    for (var v = [], g = f; g < h; )
      vc(g, o, e, r) && v.push(g), (g = t.add(g, o.slotDuration));
    o.slotDates = v;
    var m = -1,
      y = 0,
      S = [],
      E = [];
    for (g = f; g < h; )
      vc(g, o, e, r) ? ((m += 1), S.push(m), E.push(y)) : S.push(m + 0.5),
    ...
    return (
      ...
      (o.slotsPerLabel = Ft(o.labelInterval, o.slotDuration)),
      o
    );
  }
  function hc(e, t, n) {
    ...
    return (
      t.isTimeScale ||
        ((r = ut(r)), t.largeUnit && (r = n.startOf(r, t.largeUnit))),
      r
    );
  }
  function vc(e, t, n, r) {
    ...
    if (!o) {
      if (e.slotDuration) {
        ...
        for (var u = 0, c = pc; u < c.length; u++) {
          if (
            ((o = Ht(c[u])), n.countDurationsBetween(r.start, r.end, o) >= 18)
          )
            break;
        }
      e.labelInterval = o;
  ...
  var Cc = (function (e) {
    function t() {
      var t = (null !== e && e.apply(this, arguments)) || this;
      return (
        (t.refineHookProps = Jt(bc)),
        (t.normalizeClassNames = si()),
        (t.buildCellNavLinkAttrs = $t(Dc)),
        t
      );
    }
    return (
      ...
      (t.prototype.render = function () {
        var e = this,
          ...
          u = ["fc-timeline-slot", "fc-timeline-slot-label"].concat(
            "time" === i.rowUnit ? ho(l, n.theme) : fo(l, n.theme)
          );
    ...
    wc = (function () {
      function e(e, t, n, r, o, i) {
        (this.slatRootEl = e),
          ...
          (this.dateEnv = o),
          (this.isRtl = i),
          (this.outerCoordCache = new ko(e, t, !0, !1)),
          (this.innerCoordCache = new ko(e, De(t, "div"), !0, !1));
      }
      return (
          ...
          var e = this,
            ...
            o =
              t.slatCoords && t.slatCoords.dateProfile === t.dateProfile
                ? t.slatCoords
                : null;
          return Oo(Pa, { unit: r }, function (r, i) {
            return Oo(
              "div",
              ...
              n.options.nowIndicator &&
                Oo(
                  ...
                  o &&
                    o.isDateInRange(r) &&
                    Oo(hs, { isAxis: !0, date: r }, function (e, t, i, a) {
                      return Oo(
                        "div",
                        {
                          ref: e,
      ...
      return (
        ...
        (t.prototype.render = function () {
          ...
          return (
            ...
            c.push.apply(c, e.isDay ? fo(u, i) : ho(u, i)),
            Oo(
              ni,
              {
                hookProps: p,
  ...
  var Hc = (function (e) {
          ...
          var o = this.props,
            ...
            u = e.map(function (e, t) {
              ...
              return Oo(
                ...
                "bg-event" === n ? Oo(Es, r({ seg: e }, hr(e, i, a))) : Ss(n)
              );
            });
          return Oo(Lo, null, u);
        }),
    ...
    Uc = (function (e) {
      function t() {
        ...
        return (
          (t.slicer = new Oc()),
          (t.sortEventSegs = $t(lr)),
          (t.harnessElRefs = new Ka()),
          (t.moreElRefs = new Ka()),
          (t.innerElRef = Wo()),
        ...
        (t.prototype.render = function () {
          var e = this,
            ...
            c = (function (e, t, n, r, o, i) {
              ...
              var f = p.addSegs(a),
                h = f.map(function (t) {
                  return { seg: e[t.index], hcoords: t.span, top: null };
                }),
                v = oa(f),
                g = [],
                m = [],
              ...
              u,
              Nc(u, o.eventMinWidth, t.timelineCoords),
  ...
  Uc.addStateEquality({ eventInstanceHeights: wt, moreLinkHeights: wt });
  var Bc = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
        return (
              ...
              return Oo(
                ...
                i.nowIndicator &&
                  ...
                  Oo(
                    "div",
                    { className: "fc-timeline-now-indicator-container" },
                    Oo(hs, { isAxis: !1, date: t }, function (e, n, i, a) {
                      return Oo(
                        "div",
                        {
                          ref: e,
    ...
    zc = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
        return (
          (t.buildTimelineDateProfile = $t(fc)),
          (t.scrollGridRef = Wo()),
      ...
      return (
        ...
        (t.prototype.render = function () {
          ...
          return (
            ...
            Oo(ci, { viewSpec: i.viewSpec }, function (t, r) {
              return Oo(
                "div",
  ...
  var Yc = (function () {
    function e() {
      (this.buildResourceEventUis = $t(Zc, wt)),
        (this.injectResourceEventUis = $t(Xc));
    }
    return (
      (e.prototype.transform = function (e, t) {
        return t.viewSpec.optionDefaults.needsResourceData
      ...
      case "CHANGE_VIEW_TYPE":
        return (function (e, t, n, r) {
          if (
            ...
            (!e.fetchRange || !Jn(e.fetchRange, t))
          )
            return od(e, t, r);
          return e;
  ...
  var cd = { resourceId: String, resourceIds: wn, resourceEditable: Boolean };
  var dd = (function () {
    function e(e, t) {
    ...
    return (
      ...
      (e.prototype.getEvents = function () {
        ...
        for (var a in o) {
          var s = o[a],
            l = r[s.defId];
          -1 !== l.resourceIds.indexOf(e) && i.push(new Ar(t, l, s));
        }
        return i;
      }),
      Object.defineProperty(e.prototype, "id", {
  ...
  (Or.prototype.addResource = function (e, t) {
    ...
    (Or.prototype.getResources = function () {
      var e = this.getCurrentData(),
        t = e.resourceStore,
        n = [];
      if (t) for (var r in t) n.push(new dd(e, t[r]));
      return n;
    }),
    (Or.prototype.getTopLevelResources = function () {
      var e = this.getCurrentData(),
        t = e.resourceStore,
        n = [];
      if (t) for (var r in t) t[r].parentId || n.push(new dd(e, t[r]));
      return n;
    }),
  ...
  function fd(e, t) {
    return r(r({}, t), { constraints: hd(e, t.constraints) });
  }
  function hd(e, t) {
    ...
    Cd = (function (e) {
      ...
      return (
        ...
        (t.prototype.render = function () {
          ...
          return Oo(Pa, { unit: "day" }, function (o, i) {
        ...
        (t.prototype.renderResourceRow = function (e, t) {
          var n = e.map(function (e) {
            return Oo(bd, { key: e.id, resource: e, colSpan: 1, date: t });
          });
        ...
        (t.prototype.renderDateCell = function (e, t, n, r, o, i) {
          var a = this.props,
            s = o ? ":" + o.id : "",
            l = o ? { resource: new dd(this.context, o) } : {},
        ...
        (t.prototype.buildTr = function (e, t) {
          ...
          return (
            e.length || (e = [Oo("td", { key: 0 }, " ")]),
            Oo("tr", { key: t, role: "row" }, n && n(t), e)
          );
        }),
        t
      );
  ...
  var Rd = function (e) {
          ...
          for (
            ...
            for (var a = [], s = 0; s < n.colCnt; s += 1)
              for (var l = 0; l < r.length; l += 1) {
                var u = r[l],
                  c = { resource: new dd(this.context, u) },
    ...
    kd = (function () {
      function e() {
        (this.joinDateSelection = $t(this.joinSegs)),
          (this.joinBusinessHours = $t(this.joinSegs)),
          (this.joinFgEvents = $t(this.joinSegs)),
          (this.joinBgEvents = $t(this.joinSegs)),
          (this.joinEventDrags = $t(this.joinInteractions)),
          (this.joinEventResizes = $t(this.joinInteractions));
      }
      return (
        (e.prototype.joinProps = function (e, t) {
          for (
            ...
            n.push(f.dateSelectionSegs),
              r.push(p ? f.businessHourSegs : xd),
              i.push(p ? f.fgEventSegs : xd),
      ...
      Nd(
        (function (e, t, n, r) {
          var o = (function (e, t) {
              ...
              for (var r in e) {
                var o = e[r];
                n[r] = { resource: o, resourceFields: Ad(o), children: [] };
              }
              for (var r in e) {
                if ((o = e[r]).parentId) {
                  var i = n[o.parentId];
  ...
  var Ld = Jo({
      ...
      isPropsValid: function (e, t) {
        ...
        for (var o in n) {
          ...
          if (
            ...
            !Fa(i, t, { resourceId: o }, fd.bind(null, o)))
          )
            return !1;
        }
        return !0;
    ...
    zd = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
        return (
          (t.flattenResources = $t(Id)),
          (t.buildResourceDayTableModel = $t(Vd)),
          (t.headerRef = Wo()),
          (t.tableRef = Wo()),
          t
        );
  ...
  var Fd = Jo({
    ...
    qd = (function (e) {
      function t() {
        ...
        return (
          (t.flattenResources = $t(Id)),
          (t.buildResourceTimeColsModel = $t(Yd)),
          (t.buildSlatMetas = $t(fu)),
          t
        );
      }
      return (
  ...
  function Xd(e) {
    for (
      ...
      a.push(Oo("span", { className: "fc-icon" }));
    var l = ["fc-icon"];
    return (
      ...
      (t.prototype.render = function () {
        ...
        return Oo(
          ...
          e.colSpecs.map(function (i, a) {
            ...
            return s > 1
              ? Oo(ep, { key: a, colSpec: i, fieldValue: l, rowSpan: s })
              : Oo(Qd, {
                  key: a,
                  colSpec: i,
                  resource: t,
  ...
  np.addPropsEquality({ rowSpans: Kt });
  var rp = (function (e) {
    function t() {
      var t = (null !== e && e.apply(this, arguments)) || this;
      return (
  ...
  rp.addPropsEquality({ group: Wd });
  var ip = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
        return (
          (t.resizerElRefs = new Ka(t._handleColResizerEl.bind(t))),
          (t.colDraggings = {}),
          t
        );
      }
    ...
    ap = (function (e) {
      ...
      return (
        ...
        (t.prototype.render = function () {
          var e = this.props,
            t = this.context,
            n = { resource: new dd(t, e.resource) };
          return Oo(
            oi,
            ...
            function (e, t) {
              return (
                t &&
                Oo("div", { className: "fc-timeline-lane-misc", ref: e }, t)
              );
            }
          );
        }),
  ...
  function lp(e) {
    return { resource: new dd(e.context, e.resource) };
  }
  var up = (function (e) {
      function t() {
        return (null !== e && e.apply(this, arguments)) || this;
            ...
            Oo(
              ...
              function (n, r, o, i) {
                return Oo(
                  ...
                  Oo("div", { style: { height: t.innerHeight }, ref: o }, i)
                );
              }
            )
          );
  ...
  var pp = (function (e) {
    function t() {
      var t = (null !== e && e.apply(this, arguments)) || this;
      return (
        (t.computeHasResourceBusinessHours = $t(fp)),
        (t.resourceSplitter = new pd()),
        (t.bgSlicer = new Oc()),
        (t.slatsRef = Wo()),
        (t.state = { slatCoords: null }),
        (t.handleEl = function (e) {
            ...
            return Oo(
              ...
              o.options.nowIndicator &&
                ...
                Oo(
                  "div",
                  { className: "fc-timeline-now-indicator-container" },
                  Oo(hs, { isAxis: !1, date: t }, function (e, n, r, i) {
                    return Oo(
                      "div",
                      {
                        ref: e,
  ...
  var hp = (function (e) {
      function t() {
        ...
        return (
          (t.scrollGridRef = Wo()),
          (t.timeBodyScrollerElRef = Wo()),
          (t.spreadsheetHeaderChunkElRef = Wo()),
          (t.rootElRef = Wo()),
    ...
    vp = (function (e) {
      function t(t, n) {
        var r = e.call(this, t, n) || this;
        return (
          (r.processColOptions = $t(Sp)),
          (r.buildTimelineDateProfile = $t(fc)),
          (r.hasNesting = $t(yp)),
          (r.buildRowNodes = $t(Pd)),
          (r.layoutRef = Wo()),
          (r.rowNodes = []),
          (r.renderedRowNodes = []),
          (r.buildRowIndex = $t(gp)),
      ...
      return (
        ...
        (t.prototype.render = function () {
          ...
          return Oo(ci, { viewSpec: a }, function (t, i) {
            return Oo(
              "div",
  ...
  vp.addStateEquality({ spreadsheetColWidths: Kt });
  var Ep = Jo({
    deps: [Ou, Ld, Fc],
  ...
  return (
    Li.push(al, Pl, gu, Tu, xu, Mu, oc, sc, Fc, Ld, Fd, Zd, Ep),
    (e.AbstractResourceDayTableModel = wd),
    (e.BASE_OPTION_DEFAULTS = mn),
    (e.BASE_OPTION_REFINERS = gn),
    (e.BaseComponent = Yo),
    (e.BgEvent = Es),
    (e.BootstrapTheme = _u),
    (e.Calendar = Ps),
    (e.CalendarApi = Or),
    (e.CalendarContent = Ca),
    (e.CalendarDataManager = Vi),
    (e.CalendarDataProvider = Qi),
    (e.CalendarRoot = wa),
    (e.Component = Ho),
    (e.ContentHook = oi),
    (e.CustomContentRenderContext = ri),
    (e.DEFAULT_RESOURCE_ORDER = gd),
    (e.DateComponent = $o),
    (e.DateEnv = Gr),
    (e.DateProfileGenerator = vi),
    (e.DayCellContent = gs),
    (e.DayCellRoot = ys),
    (e.DayGridView = Ml),
    (e.DayHeader = Ha),
    (e.DayResourceTableModel = _d),
    (e.DaySeriesModel = Aa),
    (e.DayTable = kl),
    (e.DayTableModel = Wa),
    (e.DayTableSlicer = xl),
    (e.DayTimeCols = cu),
    (e.DayTimeColsSlicer = uu),
    (e.DayTimeColsView = hu),
    (e.DelayedRunner = Ui),
    (e.Draggable = rl),
    (e.ElementDragging = fa),
    (e.ElementScrollController = Io),
    (e.Emitter = xo),
    (e.EventApi = Ar),
    (e.EventRoot = ds),
    (e.EventSourceApi = ye),
    ...
    (e.MoreLinkRoot = Ts),
    (e.MountHook = ai),
    (e.NamedTimeZoneImpl = ea),
    (e.NowIndicatorRoot = hs),
    (e.NowTimer = Pa),
    (e.PointerDragging = As),
    (e.PositionCache = ko),
    (e.RefMap = Ka),
    (e.RenderHook = ni),
    (e.ResourceApi = dd),
    (e.ResourceDayHeader = Cd),
    (e.ResourceDayTable = Bd),
    (e.ResourceDayTableModel = Td),
    (e.ResourceDayTableView = zd),
    (e.ResourceDayTimeCols = jd),
    (e.ResourceDayTimeColsView = qd),
    (e.ResourceLabelRoot = Sd),
    (e.ResourceSplitter = pd),
    (e.ResourceTimelineLane = sp),
    (e.ResourceTimelineView = vp),
    (e.ScrollController = Mo),
    (e.ScrollGrid = qu),
    (e.ScrollResponder = Fo),
    (e.Scroller = Xa),
    (e.SegHierarchy = ta),
    ...
    (e.TableView = sl),
    (e.Theme = No),
    (e.ThirdPartyDraggable = il),
    (e.TimeCols = su),
    (e.TimeColsSlatsCoords = zl),
    (e.TimeColsView = Ul),
    (e.TimelineCoords = wc),
    (e.TimelineHeader = kc),
    (e.TimelineHeaderRows = Rc),
    (e.TimelineLane = Uc),
    (e.TimelineLaneBg = Hc),
    (e.TimelineLaneSlicer = Oc),
    (e.TimelineSlats = Pc),
    (e.TimelineView = zc),
    (e.VResourceJoiner = kd),
    (e.VResourceSplitter = Md),
    (e.ViewApi = Mr),
    (e.ViewContextType = Go),
    (e.ViewRoot = ci),
    (e.WeekNumberRoot = Cs),
    ...
    (e.addMs = rt),
    (e.addWeeks = tt),
    (e.allowContextMenu = Ge),
    (e.allowSelection = Ve),
    (e.applyMutationToEventStore = _r),
    (e.applyStyle = we),
    (e.applyStyleProp = Te),
    (e.asCleanDays = At),
    (e.asRoughMinutes = Bt),
    ...
    (e.buildDayRanges = du),
    (e.buildDayTableModel = Il),
    (e.buildEntryKey = ra),
    (e.buildEventApis = Lr),
    (e.buildEventRangeKey = gr),
    ...
    (e.buildIsoString = jt),
    (e.buildNavLinkAttrs = mo),
    (e.buildResourceFields = Ad),
    (e.buildRowNodes = Pd),
    (e.buildSegCompareObj = ur),
    (e.buildSegTimeText = fr),
    (e.buildSlatCols = Vc),
    (e.buildSlatMetas = fu),
    (e.buildTimeColsModel = vu),
    (e.buildTimelineDateProfile = fc),
    (e.collectFromHash = kt),
    (e.combineEventUis = An),
    (e.compareByFieldSpec = Ye),
    (e.compareByFieldSpecs = qe),
    (e.compareNumbers = $e),
    (e.compareObjs = _t),
    (e.computeEarliestSegStart = ks),
    (e.computeEdges = Do),
    (e.computeFallbackHeaderFormat = Ta),
    ...
    (e.computeSegEndResizable = pr),
    (e.computeSegStartResizable = dr),
    (e.computeShrinkWidth = $a),
    (e.computeSmallestCellWidth = Qe),
    (e.computeVisibleDayRange = qn),
    (e.config = ha),
    (e.constrainPoint = oo),
    (e.coordToCss = _c),
    (e.coordsToCss = xc),
    (e.createAriaClickAttrs = Oe),
    (e.createContext = Uo),
    (e.createDuration = Ht),
    (e.createElement = Oo),
    (e.createEmptyEventStore = kn),
    (e.createEventInstance = yt),
    (e.createEventUi = On),
    (e.createFormatter = vn),
    (e.createPlugin = Jo),
    (e.createPortal = Bo),
    (e.createRef = Wo),
    (e.diffDates = Zn),
    ...
    (e.elementMatches = be),
    (e.enableCursor = Be),
    (e.eventTupleToStore = _n),
    (e.filterEventStoreDefs = In),
    (e.filterHash = bt),
    (e.findDirectChildren = De),
    (e.findElements = Ce),
    (e.flattenResources = Id),
    (e.flexibleCompare = Ze),
    (e.flushToDom = zo),
    ...
    (e.formatDayString = qt),
    (e.formatIsoTimeString = Yt),
    ...
    (e.getAllowYScrolling = Qa),
    (e.getCanVGrowWithinCell = so),
    (e.getClippingParents = To),
    (e.getDateMeta = po),
    (e.getDayClassNames = fo),
    (e.getDefaultEventEnd = Tr),
    (e.getElRoot = xe),
    (e.getElSeg = ir),
    (e.getEntrySpanEnd = na),
    (e.getEventClassNames = vr),
    (e.getEventTargetViaRoot = _e),
    (e.getIsRtlScrollbarOnLeft = Eo),
    (e.getPublicId = ld),
    (e.getRectCenter = io),
    (e.getRelevantEvents = xn),
    (e.getScrollGridClassNames = is),
    (e.getScrollbarWidths = bo),
    (e.getSectionClassNames = as),
    (e.getSectionHasLiquidHeight = Ja),
    (e.getSegAnchorAttrs = mr),
    (e.getSegMeta = hr),
    (e.getSlotClassNames = ho),
    (e.getStickyFooterScrollbar = us),
    (e.getStickyHeaderDates = ls),
    (e.getUnequalProps = Tt),
    (e.getUniqueDomId = Me),
    (e.globalLocales = jr),
    (e.globalPlugins = Li),
    (e.greatestDurationDenominator = Gt),
    (e.groupIntersectingEntries = oa),
    (e.guid = Le),
    (e.hasBgRendering = rr),
    (e.hasShrinkWidth = os),
    (e.identity = wn),
    (e.interactionSettingsStore = pa),
    (e.interactionSettingsToStore = da),
    (e.intersectRanges = $n),
    (e.intersectRects = no),
    (e.intersectSpans = aa),
    (e.isArraysEqual = Kt),
    (e.isColPropsEqual = ts),
    (e.isDateSelectionValid = za),
    (e.isDateSpansEqual = Er),
    (e.isGroupsEqual = Wd),
    (e.isInt = Je),
    (e.isInteractionValid = Ba),
    (e.isMultiDayRange = Yn),
    (e.isPropsEqual = wt),
    (e.isPropsValid = Fa),
    (e.isValidDate = gt),
    (e.joinSpans = ia),
    ...
    (e.mapHash = Ct),
    (e.memoize = $t),
    (e.memoizeArraylike = Qt),
    (e.memoizeHashlike = en),
    (e.memoizeObjArg = Jt),
    (e.mergeEventStores = Mn),
    (e.multiplyDuration = Lt),
    (e.padStart = Xe),
    (e.parseBusinessHours = eo),
    (e.parseClassNames = Pn),
    (e.parseDragMeta = ga),
    (e.parseEventDef = Gn),
    (e.parseFieldSpecs = je),
    (e.parseMarker = Fr),
    (e.pointInsideRect = to),
    (e.preventContextMenu = Fe),
    (e.preventDefault = Ie),
    (e.preventSelection = ze),
    (e.rangeContainsMarker = tr),
    (e.rangeContainsRange = er),
    (e.rangesEqual = Jn),
    ...
    (e.removeExact = Xt),
    (e.render = Ao),
    (e.renderChunkContent = es),
    (e.renderFill = Ss),
    (e.renderMicroColGroup = ns),
    (e.renderScrollShim = ss),
    (e.requestJson = Oi),
    (e.sanitizeShrinkWidth = rs),
    (e.setElSeg = or),
    (e.setRef = Ko),
    (e.setScrollFromLeftEdge = Uu),
    (e.sliceEventStore = nr),
    ...
    (e.unmountComponentAtNode = Vo),
    (e.unpromisify = _o),
    (e.version = "5.10.1"),
    (e.whenTransitionDone = He),
    (e.wholeDivideDurations = Ft),
